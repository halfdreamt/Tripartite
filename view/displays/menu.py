...
class Menu:
    ...
    def draw_menu(self):
        ...
        # Draw battle button
        self.battle_button = pygame.Rect(screen_width / 2 - 100, screen_height / 2 + 50, 200, 100)
        pygame.draw.rect(self.screen, (255, 255, 255), self.battle_button)
        battle_text = self.font.render("Battle", True, (0, 0, 0))
        self.screen.blit(battle_text, (screen_width / 2 - battle_text.get_width() / 2, screen_height / 2 + 100 - battle_text.get_height() / 2))
